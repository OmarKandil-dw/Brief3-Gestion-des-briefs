...
<body>
    ...
    <ul>
      ...
      <div class="myDiv"><br>
     <h2>Nouveau brief</h2> <br>
     <form action="/add_brief/" method="get">
        <div class="col-sm-10 " id="">
            ...
            <div class="row ml-4 pt-2 ">     
                <div>
                    ...
                    <input type="date" class="form-control" name="date_de_livraison" >
                </div>
            
             <div class="mx-auto">
                <label for=""> Date de récupération</label>    
                <input type="date" class="form-control" name="date_de_récuperation">
             </div>
            </div>
